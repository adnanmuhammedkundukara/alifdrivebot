...
from alifdrivebot.Utils import Media, get_file_details 
from alifdrivebot.Broadcast import broadcast
from alifdrivebot import ABOUT
from alifdrivebot.Channel import handle_user_status
...
async def start(bot, message):
    ...
    if usr_cmdall1.startswith("/start adnanmuhammedkundukara"):
        if AUTH_CHANNEL:
